...
function buildAuditReportData(report) {
  ...
  return {
    ...
    headline_diagnosis: report?.headline_diagnosis || narr?.headline_diagnosis || es?.headline || "", executive_summary_paragraph: es?.summary_paragraph || "", executive_headline: es?.headline || "",
