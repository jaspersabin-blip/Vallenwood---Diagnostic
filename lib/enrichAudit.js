...

{
  ...
  "narrative": {
    "headline_diagnosis": "MAX 45 WORDS. Two complete sentences only. Sentence 1: what IS working (name the win reason and a commercial strength). Sentence 2: what is breaking and why it matters commercially (name the constraint and the lose reason). No framework labels. Must end with a period.",
