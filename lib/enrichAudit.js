...

{
  "swot": {
    ...
    "weaknesses": [
      {"point": "One sentence using exploratory language: what this pattern may suggest about where value is not converting — reference the specific constraint and inputs. Use 'may indicate', 'often suggests', or 'this pattern points to'. Do not declare facts."},
      {"point": "One sentence using exploratory language: a second pattern from a different pillar that may be contributing. Reference a specific input signal. Use conditional framing."},
      {"point": "One sentence using exploratory language: a third pattern — must be distinct from the first two. Use 'worth exploring whether' or 'this may suggest'."}
    ],
    "opportunities": [
  ...
  "root_cause_hypotheses": [
    {
      "hypothesis": "The most likely hypothesis — framed as a testable possibility, not a declaration. Use 'this may be because', 'one likely explanation is', 'it appears that'. Reference actual inputs.",
      "probability": "High",
      "what_it_looks_like": "Two or three observable signs a sales leader or CMO would recognize — framed as 'you may notice', 'this often shows up as', not as certain facts",
      "first_test": "The fastest concrete action to validate or disprove this hypothesis — direct and actionable"
    },
    {
      "hypothesis": "A second hypothesis from a different angle — still grounded in inputs, framed as a possibility worth exploring",
      "probability": "Medium",
      "what_it_looks_like": "Observable signs that would show up differently than hypothesis one — framed conditionally",
      "first_test": "How to test this quickly and cheaply"
    },
    {
      "hypothesis": "A third alternative hypothesis — the explanation worth considering if the first two don't hold",
      "probability": "Lower",
      "what_it_looks_like": "What this might look like in practice — distinct from the first two, framed as a possibility",
      "first_test": "How to test this hypothesis"
    }
  ],
  "constraint_chain": [
    "COMPLETE SENTENCE, MAX 40 WORDS: How ${primaryConstraint} may be creating pressure on a second pillar — name both and the likely mechanism. Use 'may be limiting', 'often creates', or 'tends to'. Must end with a period.",
    "COMPLETE SENTENCE, MAX 40 WORDS: How that second-order effect could be creating a third problem — trace to a likely commercial outcome. Use 'this can lead to', 'which may explain'. Must end with a period.",
    "COMPLETE SENTENCE, MAX 40 WORDS: The likely commercial direction if this constraint is not addressed in 12-18 months — framed as a risk worth considering, not a certainty. Must end with a period."
  ],
  "narrative": {
