...

{
  ...
  "narrative": {
    "headline_diagnosis": "MAX 30 WORDS TOTAL. One sentence only. Name what is working (the win reason) and what constraint is limiting it commercially. Must be a single complete sentence ending with a period. No more than 30 words.",
    "what_this_means_in_practice": [
      "COMPLETE SENTENCE, MAX 25 WORDS: A specific commercial symptom referencing the discount frequency or close rate. Must end with a period.",
      "COMPLETE SENTENCE, MAX 25 WORDS: A second symptom referencing the positioning consistency or attribution signal. Must end with a period.",
      "COMPLETE SENTENCE, MAX 25 WORDS: A third symptom referencing the lose reason and specific competitors. Must end with a period.",
      "COMPLETE SENTENCE, MAX 25 WORDS: A fourth symptom connecting the measurement gap to a specific business decision. Must end with a period."
    ],
